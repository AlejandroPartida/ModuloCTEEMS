...
<body>
                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Editar Retroalimentacion</h4>

                        </div>
                        <div class="modal-body">
                            <form action="tables-retroalimentacion.php" method="post" >
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Retroalimetación</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        if(isset($_POST["editar"])) {
                                            ...
                                            $sqlUpdate = "UPDATE retroalimentacion SET descripcion = '$descri' WHERE id = $id";
            ...
            if(isset($_POST['visto'])){
                    ...
                    if(!$dbconn) {
                      echo "Error: No se ha podido conectar a la base de datos\n";
                        ...
                        $sql=mysqli_query($dbconn,"SELECT * FROM retroalimentacion where id='$numero'");
    ...
    <script src="assets/js/editarRetro.js"></script>

                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Editar Situaciones</h4>

                        </div>
                        <div class="modal-body">
                            <form action="tables-situaciones.php" method="post" >
                        ...
                        <div class="page-header float-right">
                            <div class="page-title">
                                <ol class="breadcrumb text-right">
                                    ...
                                    <li class="active">Situaciones</li>
                                </ol>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <strong class="card-title">Situaciones</strong>
                            </div>
                            <div class="card-body">
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        if(isset($_POST["editar"])) {
                                            ...
                                            $sqlUpdate = "UPDATE situaciones SET descripcion = '$descri' WHERE id = $id";
                                        ...
                                        $sql = "SELECT * FROM situaciones;";
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                ...
                                                echo      "<td>" .$row["descripcion"]. "</td>";
                                                  ...
                                                  echo "<td>
                                                  <form method='post' action='tables-situaciones.php'>
...
<script language="JavaScript">
                  ...
                  if(isset($_POST['visto'])){
                    ...
                    if(!$dbconn) {
                      echo "Error: No se ha podido conectar a la base de datos\n";
                        ...
                        $sql=mysqli_query($dbconn,"SELECT * FROM situaciones where id='$numero'");
    ...
    <script src="assets/js/editarSito.js"></script>

...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <?php
      ...
      $sql=mysqli_query($dbconn,"SELECT * FROM programas Where idPrograma ='$numero'");
      ...
      $cellWidth = 70;
        ...
        $pdf -> Write(14, $reg['varNomProg']);
        $pdf -> Ln(30);
        $pdf->Cell(40);

        $pdf -> Write(14, $reg['txtObjetivo']);
        $pdf -> Ln(15);
        $pdf->Cell(40);
        
        $pdf -> Write(14, $reg['dateFechaIni']."                                ".$reg['dateFechaFin']);
        $pdf -> Ln(15);
        $pdf->Cell(80);

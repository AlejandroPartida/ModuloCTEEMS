        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    <br>
                    <li>
                        <a href="lista_programas.html"><i class="menu-icon fa fa-pencil"></i>Programas</a>
                    </li>
                    ...
                    <div class="col-md-3">
				        ...
				        $total=mysqli_num_rows($consulta);
                            ...
                            <div class="card-header text-center">
                                ...
                                <div class="card-body">                                    
                                    ...
                                    <hr>
                                    <a href="minutas.php"><h5 class="text-sm-center mt-2 mb-1"><i class="fa fa-file-text-o"></i>&nbsp; Minutas</h5></a>
                                </div>
                            </a>
                        </div>
                        </div>';
                        ...
                        <div class="card">
                            <div class="card-header text-center">
                                ...
                                <div class="card-body">                                    
                                    <a href="#"><h5 class="text-sm-center mt-2 mb-1"><i class="fa fa-pencil-square-o"></i>&nbsp; Modificar</h5></a>
                                    <hr>
                                    <a href="#"><h5 class="text-sm-center mt-2 mb-1"><i class="fa fa-file-text-o"></i>&nbsp; Minutas</h5></a>
                                </div>
                            </a>
                        </div>
                    </div>

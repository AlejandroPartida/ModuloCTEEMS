...
<?php
                         ...
                         <div class="card-header">
                            ...
                            <div class="card-body">
                                <div class="mx-auto d-block">
                                      ...
                                      <hr>
                                    <h5 class="text-sm-center mt-2 mb-1">M I N U T A</h5>
                                </div>
                                    </a>
                        </div>
                    </div>
 ...
 <!-- DIALOGO COMITE  -->
                       ...
                       <div class="col-md-4">
                        <div class="card">
                            <a href="#" data-toggle="modal" data-target="#comite">
                                <div class="card-header">
                                ...
                                <div class="card-body">
                                    ...
                                    <hr>
                                    <h5 class="text-sm-center mt-2 mb-1">C O M I T E</h5>
                                </div>
                            </a>
                        </div>
                    </div>
...
<div class="card-body">
    ...
    <h5 class="modal-title" id="smallModalLabel"> <strong>ARCHIVOS COMITE </strong></h5>
    <br>
                                ...
                                <tbody>
<?php
                                            $sql = "SELECT * FROM dialogo_comite;";
                                            ...
                                            while($row = $result->fetch_assoc()) {
                                                $id = $row["id"];
                                                $comite = $row["comite"];
                                                $fk_programa = $row["fk_programa"];

                                                echo  "<form method='post'>";
                                                echo  "<tbody>";
                                                echo     "<tr>";
                                                echo      "<td>" .utf8_decode($row["id"])."</td>";
                                                echo      "<td>" .utf8_decode($row["comite"]). "</td>";
                                                echo      "<td>" .utf8_decode($row["fk_programa"]). "</td>";
 ...
 <h5 class="modal-title" id="smallModalLabel"> <strong> ARCHIVOS MINUTA </strong></h5>
    <br>
                            <div class="card-body">
                                ...
                                <tbody>
<?php
                                            $sql1 = "SELECT * FROM dialogo_minuta;";

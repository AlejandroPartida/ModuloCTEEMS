                ...
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <h4 class="modal-title">Editar lineamiento</h4>
        ...
        <div class="content">
            <div class="animated fadeIn">
                <div class="row">
                                ...
                                <table id="bootstrap-data-table" class="table table-striped table-bordered">
                                    ...
                                    <?php
                                        ...
                                        if(isset($_POST["editar"])) {
                                            ...
                                            $sqlUpdate = "UPDATE indicadores SET id = '$id1', nombre = '$nombreL', descripcion = '$descL' WHERE id = '$id1';";
                  ...
                  <a href='pdfindicadores.php' name='imprimir' class='btn btn-primary'> Imprimir PDF <i class="fa fa-download"></i></a>
                  </div>
                </div>
                  </div>
                </div>

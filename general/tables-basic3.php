        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-title">LINEAMIENTOS</li><!-- /.menu-title -->
...
// Revisamos el estado de la conexion en caso de errores. 
                                        ...
                                        echo "\n";
                                             ...
                                             $sql=mysqli_query($dbconn,"SELECT * FROM lineamientos");
                                             ?>
                            ...
                            <table id='bootstrap-data-table' class='table table-striped table-bordered'>
                                            ...
                                            <?php
                                                ...
                                                {
                                                  echo "<tr><td>".$reg['id_lineamiento']."</td>";
                                                  echo "<td>".$reg['nombre']."</td>";
                                                  echo "<td>".$reg['descripcion']."</td>";
                                        
                                                 echo "<td>
                                                  <form method='post' action='tables-basic3.php'>
                                                    <input type='hidden' value='$reg[id_lineamiento]' name='visto'>
                ...
                if($_POST){
                    ...
                    if(!$dbconn) {
                      echo "Error: No se ha podido conectar a la base de datos\n";
                        ...
                        $sql=mysqli_query($dbconn,"SELECT * FROM lineamientos where id_lineamiento='$numero'");

                         echo "<TABLE>";

                        while ($reg=mysqli_fetch_array($sql))
                        {
                            echo "<TR><TD>Clave:   </TD><TD>".$reg['id_lineamiento']."</TD></TR>";

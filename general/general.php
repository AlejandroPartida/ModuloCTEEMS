        ...
        <nav class="navbar navbar-expand-sm navbar-default">
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                   <li class="menu-title">PROGRAMAS</li><!-- /.menu-title -->
                ...
                <div class="header-menu">
                    ...
                    <div class="user-area dropdown float-right">
                        <a href="#" class="dropdown-toggle active" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <H2><i class="fa fa- user" style="color: #ddd"></i></H2>
                        </a>
 ...
 ?>
       <div class="breadcrumbs">
        ...
        <form action="general.php" method="POST">
            ...
            <input type="text" name="buscador" placeholder="Ingrese clave del plantel">
...
$SQL_READ= "SELECT * FROM programas WHERE fk_plantel LIKE '%$buscar%' ";

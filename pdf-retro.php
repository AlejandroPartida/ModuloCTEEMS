    ...
    <?php
      ...
      class PDF extends FPDF {
          function Header() {
              ...
              $this->Image('retro.png', 0, 0, 210, 297);
      ...
      retroalimentacion.descripcion as retroalimentacion ,nom_prog, objetivo, fecha_ini, fecha_fin, retroalimentacion.descripcion as retrodesc  FROM plantel JOIN programas
       ...
       plan_mejora.id_programa=programas.id WHERE retroalimentacion.id='$numero'");
